...
Source Database       : db_li_blog

Target Server Type    : MYSQL
Target Server Version : 80022
File Encoding         : 65001

Date: 2021-01-09 19:44:10
*/
...
CREATE TABLE `t_test` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='一个测试表';
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('1', 'blog', 'li', '123456', '123456@qq.com', 'www', '1', '2020-03-08 18:25:26', null);
